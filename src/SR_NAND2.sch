...
C {ipin.sym} 110 -250 0 0 {name=p12 lab=R}
...
C {/foss/designs/PLL2_4/src/NAND3.sym} 510 -200 0 0 {name=x1}
C {ipin.sym} 110 -220 0 0 {name=p14 lab=RST_N}
C {lab_pin.sym} 450 -200 0 0 {name=p15 sig_type=std_logic lab=RST_N}
