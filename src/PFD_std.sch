...
F {}
E {}
N 500 -450 610 -450 {lab=#net1}
N 500 -240 610 -240 {lab=#net2}
N 590 -340 600 -340 {lab=#net1}
N 600 -450 600 -340 {lab=#net1}
N 590 -300 600 -300 {lab=#net2}
...
C {lab_pin.sym} 680 -370 0 1 {name=p14 sig_type=std_logic lab=UP}
C {lab_pin.sym} 680 -290 0 1 {name=p15 sig_type=std_logic lab=DN}
...
C {sky130_stdcells/nand2_4.sym} 530 -320 2 0 {name=x4 VGND=GND VNB=GND VPB=VDD VPWR=VDD prefix=sky130_fd_sc_hd__ }
...
C {lab_pin.sym} 470 -320 0 0 {name=p2 sig_type=std_logic lab=RST_N}
C {sky130_stdcells/inv_8.sym} 640 -290 2 1 {name=x2 VGND=GND VNB=GND VPB=VDD VPWR=VDD prefix=sky130_fd_sc_hd__ }
C {sky130_stdcells/inv_8.sym} 640 -370 2 1 {name=x5 VGND=GND VNB=GND VPB=VDD VPWR=VDD prefix=sky130_fd_sc_hd__ }
